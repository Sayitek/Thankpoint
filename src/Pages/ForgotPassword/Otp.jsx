...
e.preventDefault();
    navigate('/forgotpassword/newpassword', {state:{
      email:otpData,
      otp
    }})
  }
  return (
    <div className='otp_password_container'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button style={{ width: '100%', marginTop: '24px' }}>CONTINUE</button>
      </form>
      
      <div style={{ textAlign: 'center', marginTop: '19px' }}>
        <span style={{ fontSize: '12px' }}>If you didn’t receive a code!</span><span style={{ color: 'red', fontSize: '12px' }}> Resend</span>
      </div>
    </div>
  )
}
